"""
Simple edge event detection

Created on Mon Oct 20 12:08:00 2014
...
def simple_edge(meter, threshold=30):
    # PART I: t to delta t
    ...
    # PART II: Application of threshold
    events = events[np.abs(events[columns[0]]) > threshold]
    return events


def steady_states(dataframe, stateThreshold=15,
                  noise_level=30):
